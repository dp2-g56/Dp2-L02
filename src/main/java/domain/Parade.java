...
@Table(indexes = { @Index(columnList = "isDraftMode, moment"), @Index(columnList = "paradeStatus, isDraftMode"),
		@Index(columnList = "title, description"), @Index(columnList = "moment"), @Index(columnList = "isDraftMode"),
		@Index(columnList = "paradeStatus") })
