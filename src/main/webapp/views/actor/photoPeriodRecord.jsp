...
<p>
	...
	<display:table pagesize="5" name="photos" id="row"
		...
		<display:column>
			...
			<form name="word" id="word" action="authenticated/periodRecord/photo/delete.do?periodRecordId=${periodRecordId}" method="post" >
...
<spring:url var="add" value="/authenticated/periodRecord/photo/create.do?periodRecordId=${periodRecordId}"/>
