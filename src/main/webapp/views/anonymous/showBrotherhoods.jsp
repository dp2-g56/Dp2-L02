...
<jstl:if test="${res}">
	<script type="text/javascript">
		alert("<spring:message code="brotherhood.deleted.error"/>");
	</script>
</jstl:if>
...
<jstl:if test="${cancelButton}">
	<spring:url var="cancelar"
		value="/showAll/annonymous/brotherhood/list.do" />
	<p>
		<a href="${cancelar}"><spring:message code="annonymous.cancel" /></a>
	</p>
</jstl:if>
